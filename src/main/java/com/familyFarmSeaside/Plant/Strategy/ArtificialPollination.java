 ...
 * @description: artificial pollination strategy
 * @author: Di
 * @create: 2019/10/30
 **/
public class ArtificialPollination implements PollinationStrategy {
    ...
    /**
     * artificial pollination for one single apple
    ...
    public void pollinate(Apple a) {
        if(a.isMature()) {
            ...
            System.out.println("one apple is successfully artificial pollinated.");
    ...
    /**
     * artificial pollination for one single cherry
    ...
    public void pollinate(Cherry c) {
        if(c.isMature()) {
            ...
            System.out.println("one cherry is successfully artificial pollinated.");
    ...
    /**
     * artificial pollination for one single potato
    ...
    public void pollinate(Potato p) {
        if(p.isMature()) {
            ...
            System.out.println("one potato is successfully artificial pollinated.");
    ...
    /**
     * artificial pollination for one single tomato
    ...
    public void pollinate(Tomato t) {
        if(t.isMature()) {
            ...
            System.out.println("one tomato is successfully artificial pollinated.");
        } else if (t.isDead()) {
            // do nothing
        } else {
            System.out.println("this plant can't be pollinated! find another one.");
